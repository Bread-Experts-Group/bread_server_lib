...
import org.bread_experts_group.api.computer.ia32.bios.Read.FloppyGeometry.Companion.floppy5_14_160K
...
class IA32ProcessorTest {
	...
	fun helloWorld() {
		...
		val monitor = IA32ProcessorVisualMonitor(computer)
		val stateMon = IA32ProcessorStateMonitor(computer)
