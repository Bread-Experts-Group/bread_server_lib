...
class SegmentDirectDataProvisioner(val segment: MemorySegment) : DirectDataProvisioner<Long> {
	...
	fun asUIntProvisioner() = object : DirectDataProvisioner<UInt> {
		override var order: ByteOrder
			get() = this@SegmentDirectDataProvisioner.order
			set(value) {
				this@SegmentDirectDataProvisioner.order = value
		...
		override fun writeS8(at: UInt, b: Byte) = this@SegmentDirectDataProvisioner.writeS8(at.toLong(), b)
		override fun writeS16(at: UInt, s: Short) = this@SegmentDirectDataProvisioner.writeS16(at.toLong(), s)
		override fun writeS32(at: UInt, i: Int) = this@SegmentDirectDataProvisioner.writeS32(at.toLong(), i)
		override fun writeS64(at: UInt, l: Long) = this@SegmentDirectDataProvisioner.writeS64(at.toLong(), l)
		override fun write(at: UInt, b: ByteArray, offset: Int, length: Int) =
			this@SegmentDirectDataProvisioner.write(at.toLong(), b, offset, length)

		override fun fill(at: UInt, n: UInt, v: Byte) = this@SegmentDirectDataProvisioner.fill(
			at.toLong(), n.toLong(), v
		)

		override fun readS8(at: UInt): Byte = this@SegmentDirectDataProvisioner.readS8(at.toLong())
		override fun readS16(at: UInt): Short = this@SegmentDirectDataProvisioner.readS16(at.toLong())
		override fun readS32(at: UInt): Int = this@SegmentDirectDataProvisioner.readS32(at.toLong())
		override fun readS64(at: UInt): Long = this@SegmentDirectDataProvisioner.readS64(at.toLong())
		override fun readN(at: UInt, n: Int): ByteArray = this@SegmentDirectDataProvisioner.readN(at.toLong(), n)
		override fun flush() {}
	}
