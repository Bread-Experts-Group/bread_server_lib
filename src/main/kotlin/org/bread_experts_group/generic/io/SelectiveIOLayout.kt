...
class SelectiveIOLayout<O>(
	private val selectors: Map<KFunction<Boolean>, org.bread_experts_group.generic.io.IOLayout<out O>>,
	private val writeAction: (org.bread_experts_group.generic.io.BaseWritingIO, O) -> Unit,
	private vararg val layouts: org.bread_experts_group.generic.io.IOLayout<out Any?>
