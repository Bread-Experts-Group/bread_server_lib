...
import org.bread_experts_group.generic.io.*
import org.bread_experts_group.generic.protocol.ip.InternetProtocol
...
data class InternetProtocolV4(
	...
	companion object {
		fun read(
			...
			val dscp = (o2.toUInt() shr 2).toUByte()
			val ecn = o2 and 11u
			val flags = (flagsFOffset.toUInt() shr 13).toUByte()
