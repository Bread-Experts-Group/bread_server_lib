...
abstract class _IP_ADAPTER_WINS_SERVER_ADDRESS_LH : Structure<_IP_ADAPTER_WINS_SERVER_ADDRESS_LH> {
	@Order(0)
	abstract var Union1: U1

	@Order(1)
	abstract var Next: Pointer<_IP_ADAPTER_WINS_SERVER_ADDRESS_LH>
...
typealias IP_ADAPTER_WINS_SERVER_ADDRESS_LH = _IP_ADAPTER_WINS_SERVER_ADDRESS_LH
typealias PIP_ADAPTER_WINS_SERVER_ADDRESS_LH = Pointer<_IP_ADAPTER_WINS_SERVER_ADDRESS_LH>