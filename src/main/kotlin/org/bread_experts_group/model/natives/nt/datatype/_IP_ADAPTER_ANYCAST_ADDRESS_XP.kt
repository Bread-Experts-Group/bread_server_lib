...
abstract class _IP_ADAPTER_ANYCAST_ADDRESS_XP : Structure<_IP_ADAPTER_ANYCAST_ADDRESS_XP> {
	@Order(0)
	abstract var Union1: U1

	@Order(1)
	abstract var Next: Pointer<_IP_ADAPTER_ANYCAST_ADDRESS_XP>
...
typealias IP_ADAPTER_ANYCAST_ADDRESS_XP = _IP_ADAPTER_ANYCAST_ADDRESS_XP
typealias PIP_ADAPTER_ANYCAST_ADDRESS_XP = Pointer<_IP_ADAPTER_ANYCAST_ADDRESS_XP>