...
class LoadGlobalDescriptorTableRegister(val mod: Int, val rm: Int) : Instruction {
	override fun execute(processor80386: Processor80386) {
		if (processor80386.address32) {
			...
			if (processor80386.operand32) {
				processor80386.GDTR_LIMIT.du = processor80386.memorySource.readU16K(sAddress!!)
				processor80386.GDTR_BASE.qu = processor80386.memorySource.readU32K(sAddress + 2u)
