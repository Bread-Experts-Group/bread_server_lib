...
import org.bread_experts_group.ffi.windows.advapi.nativeFileEncryptionStatusWide
...
class WindowsSystemDeviceQueryTransparentEncryptionFeature(
	...
	override fun supported(): Boolean = nativeFileEncryptionStatusWide != null

	override fun query(): List<TransparentEncryptionSystemDeviceStatusIdentifier> {
		val status = nativeFileEncryptionStatusWide!!.invokeExact(
