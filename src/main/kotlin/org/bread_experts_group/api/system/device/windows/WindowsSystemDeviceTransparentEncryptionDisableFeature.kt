...
import org.bread_experts_group.ffi.windows.advapi.nativeDecryptFileWide
...
class WindowsSystemDeviceTransparentEncryptionDisableFeature(
	...
	override fun supported(): Boolean = nativeDecryptFileWide != null && nativeEncryptionDisable != null
	...
	override fun disable(
		...
		if (features.contains(WindowsTransparentEncryptionDisableFeatures.DIRECTORY)) {
			...
			val status = nativeDecryptFileWide!!.invokeExact(
				capturedStateSegment,
				pathSegment,
				0
			) as Int
