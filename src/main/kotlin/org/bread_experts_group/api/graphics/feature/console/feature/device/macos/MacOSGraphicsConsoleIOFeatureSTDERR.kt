...
class MacOSGraphicsConsoleIOFeatureSTDERR : GraphicsConsoleIOFeature() {
	override val expresses: FeatureExpression<GraphicsConsoleIOFeature> = GraphicsConsoleFeatures.STANDARD_ERROR
