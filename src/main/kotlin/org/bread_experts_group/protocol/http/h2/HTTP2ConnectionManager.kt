...
class HTTP2ConnectionManager private constructor(
	...
	fun signalStreamReset(stream: Int, code: MappedEnumeration<UInt, HTTP2StandardErrorCodes>) {
		writeLock.acquire()
	...
	private val streamHeaders = LinkedBlockingQueue<HTTP2HeaderMessage>()
