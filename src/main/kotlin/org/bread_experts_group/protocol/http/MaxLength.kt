...
import org.bread_experts_group.protocol.http.h11.HTTP11ParsingFeatureIdentifier
 ...
 * @since D1F3N6P0
 */
sealed class MaxLength(val length: Int) : HTTP11ParsingFeatureIdentifier {
	/**
	 ...
	 * @since D1F3N6P0
	 */
	class ReasonPhrase(length: Int) : MaxLength(length), HTTP11ResponseParsingFeatureIdentifier
	 ...
	 * @since D1F3N6P0
	 */
	class Method(length: Int) : MaxLength(length), HTTP11RequestParsingFeatureIdentifier
	 ...
	 * @since D1F3N6P0
	 */
	class Target(length: Int) : MaxLength(length), HTTP11RequestParsingFeatureIdentifier
	...
	sealed class Field(
		length: Int
	) : MaxLength(length), HTTP11ResponseParsingFeatureIdentifier, HTTP11RequestParsingFeatureIdentifier {
		/**
