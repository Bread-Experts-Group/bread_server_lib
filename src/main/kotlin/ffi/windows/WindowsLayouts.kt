...
import org.bread_experts_group.api.computer.BinaryUtil.toUInt
...
class SerialCommunicationDeviceControl(arena: Arena) {
	...
	var abortCommunicationOnError: Boolean
		...
		set(value) {
			DCB_fAbortOnError.set(ptr, 0, value.toUInt())
		}
