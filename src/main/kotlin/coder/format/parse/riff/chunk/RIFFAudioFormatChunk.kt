...
class RIFFAudioFormatChunk(
	...
	override fun toString(): String = "RIFFChunk.\"$tag\"[$encoding, $numberOfChannels channel(s), " +
		...
		val dataChunk = parent.firstOrNull { it.resultSafe.tag == "data" } ?: return@let ""
		", ${(dataChunk.resultSafe.data.size.toDouble() / byteRate).toDuration(DurationUnit.SECONDS).formatTime()}"
	} ?: "") + ']'
