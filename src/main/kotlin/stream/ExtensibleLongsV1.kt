...
fun InputStream.readExtensibleLongV1(): Long {
...
fun OutputStream.writeExtensibleLongV1(value: Long) {
...
fun InputStream.readExtensibleULongV1(): ULong {
	var position = 0
	var joined = 0uL
	do {
		val byte = this.read()
...
fun OutputStream.writeExtensibleULongV1(value: ULong) {
	var remainder = value
	do {
