...
import org.bread_experts_group.protocol.old.dns.opt.DNSOption
import org.bread_experts_group.protocol.old.dns.opt.DNSOptionRecord
import org.bread_experts_group.protocol.old.dns.opt.DNSOptionType
		...
		fun read(stream: InputStream, lookbehind: ByteArray): DNSResourceRecord {
			...
			return when (rrType) {
				DNSType.OPT__OPTION.id -> DNSOptionRecord(
					...
					label,
					DNSType.entries.id(rrType).enum!!,
