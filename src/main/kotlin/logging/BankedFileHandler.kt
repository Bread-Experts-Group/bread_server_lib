...
class BankedFileHandler(
	...
	@Suppress("LongLine", "SpellCheckingInspection", "HardCodedStringLiteral")
	@OptIn(ExperimentalStdlibApi::class)
	companion object {
		val englishHuffman: Pair<HuffmanBranch<Char>, Int> = HuffmanBranch.import(
		...
		val japaneseHuffman: Pair<HuffmanBranch<Char>, Int> = HuffmanBranch.import(
		...
		val huffmen: List<Pair<HuffmanBranch<Char>, Int>> = listOf(englishHuffman, japaneseHuffman)
	...
	private val memoryBank = readMemoryBank(bank)
	private var closed = false
	private var timeIndex = 0uL
